...
// ../../node_modules/.pnpm/tsup@8.4.0_@microsoft+api-extractor@7.51.0_@types+node@22.13.5__jiti@2.4.2_postcss@8.5._e24c940c68f85edf45ea53d737585016/node_modules/tsup/assets/esm_shims.js
...
var require_path = __commonJS({
  "../../node_modules/.pnpm/fast-glob@3.3.3/node_modules/fast-glob/out/utils/path.js"(exports) {
    ...
    function makeAbsolute(cwd2, filepath) {
      return path3.resolve(cwd2, filepath);
    }
  ...
  "../../node_modules/.pnpm/fast-glob@3.3.3/node_modules/fast-glob/out/settings.js"(exports) {
    ...
    var Settings = class {
      ...
      _getFileSystemMethods(methods2 = {}) {
        return Object.assign(Object.assign({}, exports.DEFAULT_FILE_SYSTEM_ADAPTER), methods2);
      }
    };
    exports.default = Settings;
  }
...
var DIR_DIST = typeof __dirname !== "undefined" ? __dirname : dirname(fileURLToPath2(import.meta.url));
...
// src/rpc/assets.ts
function guessType(path3) {
  if (/\.(?:png|jpe?g|jxl|gif|svg|webp|avif|ico|bmp|tiff?)$/i.test(path3))
    return "image";
  if (/\.(?:mp4|webm|ogv|mov|avi|flv|wmv|mpg|mpeg|mkv|3gp|3g2|ts|mts|m2ts|vob|ogm|ogx|rm|rmvb|asf|amv|divx|m4v|svi|viv|f4v|f4p|f4a|f4b)$/i.test(path3))
    return "video";
  if (/\.(?:mp3|wav|ogg|flac|aac|wma|alac|ape|ac3|dts|tta|opus|amr|aiff|au|mid|midi|ra|rm|wv|weba|dss|spx|vox|tak|dsf|dff|dsd|cda)$/i.test(path3))
    return "audio";
  if (/\.(?:woff2?|eot|ttf|otf|ttc|pfa|pfb|pfm|afm)/i.test(path3))
    return "font";
  if (/\.(?:json[5c]?|te?xt|[mc]?[jt]sx?|md[cx]?|markdown|ya?ml|toml)/i.test(path3))
    return "text";
  if (/\.wasm/i.test(path3))
    return "wasm";
  return "other";
}
function getAssetsFunctions(ctx) {
  ...
  async function scan() {
    ...
    cache = await Promise.all(files.map(async (relativePath) => {
      ...
      const path3 = relativePath.replace(relativePublicDir, "");
      return {
        path: path3,
        relativePath,
        publicPath: join(baseURL, path3),
        filePath,
...
init_esm_shims();
init_cjs_shim();
import { getViteRpcServer as getViteRpcServer2 } from "@vue/devtools-kit";
function getGraphFunctions(ctx) {
  const { rpc, server } = ctx;
  const debouncedModuleUpdated = debounce(() => {
    getViteRpcServer2?.()?.broadcast?.emit("graphModuleUpdated");
  }, 100);
...
function getVueDevtoolsPath() {
  const pluginPath = normalizePath(path2.dirname(fileURLToPath3(import.meta.url)));
...
export {
  VitePluginVueDevTools as default
};
